...
import SsidCredentialsDialog from "@/views/settings/SsidCredentialsDialog.vue";
               ...
               >
                  <template #item="{ element: cred, index }">
                     <v-list-item
                        :key="cred.ssid"
                        :title="cred.ssid"
                        :subtitle="showPasswords ? cred.password : '********'"
                        background="surface"
                     >
                        ...
                        <template v-slot:append>
                           <SsidCredentialsDialog
                              ...
                              @save="
                                 (event) => {
                                    onChange(event.ssid, event.password, index);
                                 }
                              "
                           />
                           <v-btn
            ...
            <v-list-item background="surface">
               <template v-slot:append>
                  ...
                  <SsidCredentialsDialog
                     @save="
                        (event) => {
                           onChange(event.ssid, event.password, undefined);
                        }
                     "
                  />
               </template>
